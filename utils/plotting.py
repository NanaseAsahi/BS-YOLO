...
class Colors:
    ...
    def __init__(self):
        ...
        # )
        hexs = (
            "7F94FF",  # 042AFF → 更浅的蓝色（原深蓝）
            "FF7F7F",  # FF0000 → 浅红色（原红）
            "FF99FF",  # FF00FF → 浅品红（原品红）
            "80EFDB",  # 00DFB7 → 更浅的青色（原青）
            "888FCC",  # 111F68 → 浅海军蓝（原深海军蓝）
            "FFB7EB",  # FF6FDD → 浅粉红（原粉红）
            "FFA2A7",  # FF444F → 浅珊瑚红（原珊瑚红）
            "E6F680",  # CCED00 → 浅黄绿（原黄绿）
            "80F9A2",  # 00F344 → 浅亮绿（原亮绿）
            "DE80FF",  # BD00FF → 浅紫色（原紫）
            "80DAFF",  # 00B4FF → 浅天蓝（原天蓝）
            "EE80DD",  # DD00BA → 浅深粉（原深粉）
            "FFFF80",  # FFFF00 → 浅黄色（原黄）
            "FFD280",  # FFA500 → 浅橙色（原橙）
            "80FFD9",  # 01FFB3 → 浅绿松石（原绿松石）
            "BE92FF",  # 7D24FF → 浅紫罗兰（原紫罗兰）
            "BD80B4",  # 7B0068 → 浅深紫（原深紫）
            "FF8DB6",  # FF1B6C → 浅玫红（原玫红）
            "FEB687",  # FC6D2F → 浅橙红（原橙红）
            "D1FF85",  # A2FF0B → 浅荧光绿（原荧光绿）
        )
